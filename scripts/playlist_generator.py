...
# Parameters
start_channel = 418000  # Starting channel number
end_channel = 425000  # Ending channel number
base_url = "http://23.227.140.75:3050/mcneelyken@ymail.com/9706320021"  # Base URL for the streams
output_dir = "/Volumes/Kyle4tb1223/_Android/_M3U/___ServersFULL"  # Directory to save the file
output_file_name = "23-227-140-75-3050FULL.m3u"  # Output file name
