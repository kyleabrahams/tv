...
# Parameters
start_channel = 50000  # Starting channel number
end_channel = 80000  # Ending channel number
# base_url = "http://server/usepassword"  # Base URL for the streams
base_url = "http://xxip25.top:8080/64869862/18743571"  # Base URL for the streams
...
output_file_name = f"xxip25-50-800-{today_date}.m3u"  # Output file name with today's date
