...
# Parameters
start_channel = 476000  # Starting channel number
end_channel = 488000  # Ending channel number
# base_url = "http://server/usepassword"  # Base URL for the streams
base_url = "http://mbsderlo.site:2082/admironold/7NeFFyN44PSYold"  # Base URL for the streams
...
output_file_name = f"mbsderlo.site-{today_date}.m3u"  # Output file name with today's date
