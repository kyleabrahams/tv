...
end_channel = 15000  # Ending channel number
# base_url = "http://server/usepassword"  # Base URL for the streams
base_url = "http://cdn1host.online:2999/live/venomj/EmoOmOskzq"  # Base URL for the streams
...
output_file_name = f"cdn1host-{today_date}.m3u"  # Output file name with today's date
